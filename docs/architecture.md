...
Ripple Structures links DWM3000 UWB ranging firmware, Python positioning, ML gesture recognition, and Unity visualization.

## Signal Flow

1. DWM3000 transmitter nodes send ranging packets.
2. DWM3000 receiver firmware records range estimates from configured transmitter anchors.
